...
namespace PetShop.Controllers
{
    ...
    public class CustomersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CustomerId,Name,LastName,Birthdate")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CustomerId,Name,LastName,Birthdate")] Customer customer)
        {
            if (ModelState.IsValid)
            {
